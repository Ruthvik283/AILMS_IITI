      ...
      <table className="min-w-full divide-y divide-gray-200">
        <thead>
          <tr>
            ...
            <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Rack Number</th>
            <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Row Number</th>
          </tr>
        </thead>
        <tbody className="bg-white divide-y divide-gray-200">
          {materialsData.map(material => (
            <tr key={material.material_id} className="hover:bg-gray-50">
              ...
              <td className="px-6 py-4 whitespace-nowrap">{material.rack_number}</td>
              <td className="px-6 py-4 whitespace-nowrap">{material.row_number}</td>
            </tr>
          ))}
        </tbody>
      </table>
